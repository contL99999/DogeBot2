...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/contL99999/DogeBot2)
...
🦄 git clone https://github.com/contL99999/v1
🦄 cd v1
🦄 ls
🦄 rm -rf session.json
🦄 npm install
